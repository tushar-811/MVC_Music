...
namespace MVC_Music.Utilities
{
    public static class ResizeImage
    {
            ...
            int max_height = 75, int max_width = 90)
        {
            ...
            var info = codec.Info.ColorSpace.IsSrgb
                ? new SKImageInfo(newWidth, newHeight)
                : new SKImageInfo(newWidth, newHeight, SKImageInfo.PlatformColorType,
            ...
            //Using SKSamplingOptions for compatibility with SkiaSharp 3.116.1+
            //to maintain high-quality image scaling.
            //Using SKCubicResampler.Mitchell provides smooth scaling
